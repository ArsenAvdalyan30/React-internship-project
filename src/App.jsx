...
import PlayAllButton from "./Components/PlayAllButton.jsx";
import AddAllButton from "./Components/AddAllButton.jsx";
    ...
    <>
      <div className={styles.app}>
        <div className={styles.songBar}>
          ...
          <div className={styles.buttonsContainer}>
            <button className={styles.buttonFormTrack}>
              <span className={styles.downUpArrow}>&#8645;</span>
